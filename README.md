...
- also, *no* copy of the Arabian Nights (back then, i hosted a copy that i had found a copy on a gopher server, and converted from a massive text blob to manageable HTML pages)
